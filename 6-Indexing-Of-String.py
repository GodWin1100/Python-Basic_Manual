...
print(state1[0:6]) #this will print character from index 0 to 5 both included
...
print(state1[0::2]) #string_variable[starting_index : ending_index : step_increment/decrement] in this case it will print element with difference of 2
