...
print(holder3)
print(holder3%('Shivam',18)) #for multiple data type the given input should be followed in same data type sequence and syntax should be followed
print('%s is my first name and %s is my last name while my date of birth is %d/%d/%d'%('Shivam','Panchal',11,10,2000)) #this can be written like this too
...
print(holder1%name)
print(holder2%age)
print(holder3%(name,age)) #placeholder can be another variable too but with same data type stored in respective variable with respect sequence
