...
print('\n')
any=input('Enter anything ')  #if data type is not specified before input then every input will be bydefault an string
print(any)
print(type(any))
number=int(input('Enter only numbers or else encounter a error '))
print(number)
print(type(number))
decimal=float(input('Enter number with decimal '
                    'or integer or else encounter a error '))
print(decimal)
print(type(decimal))
print('\n')
...
test2=(input("Enter separated by comma : ").split(','))  #here u need to put comma (,) for 2nd input or else it will consider it as one input only
...
test3=[int(x) for x in input("Enter Integers only : ").split()]  #here you can define particular datatype which will be input
print(test3)
