...
print('\nSubtraction=',num1-num2) #sutraction
print('\nDivision',num1/num2) #division gives quotient this will give answer in float i.e. in decimal format
print('\nDivison in Integer Format=',num1//num2)  #double division sign will give answer in integer format only without any decimal
...
num2=27.8
print('\nFloat Values\nDivision',num1/num2)
print('Double Division or Integer Division or Floor Division=',num1//num2)  #here it will be in float but will show only integer
print(type(num1//num2))
print('\nModulus=',num1%num2)
print('\nAddition=',num1+num2)
