...
list.append('Ara')
print(min(list)) #if elements are same it will go to next alphabet of word till the difference is found and will print accordingly
...
print(list)
list.remove('hi')  #this will remove specific element of the list it will remove only once when it is occured for first time
print(list)
...
print(list2)
list3.extend(list3)  #this also means it will append whole list
print(list3)
list3.remove('hi')  #example of remove
print(list3)
