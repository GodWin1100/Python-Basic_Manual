...
print("This is our First Meet")  # , will seperate with space while + while not seperate
n1,n2,n3,n4=5,4,8,9
print(n1,n2,n3,n4,sep=" <<this is seperator>> ")  #by default seperator(sep) is space but we can configure it using sep
print("Hello, Let's Start with Python...")   #print(' ' or " ") <<<<<for printing strings if single quote is used at start end it with single only and vice versa
