...
class subordinate(main):  #this is child class which has inherited parent class //in this case it has inherited main class
    def child(self):
        print('This is in subordinate')

trial=subordinate()
print(trial.child())  #we can approach to main class because object_trial is in subrodinate class
print(trial.parent(),trial.grandparent())  #and we can call main class function because subordinate class has inherited main class function
...
print(c.test())  #and class_child function will be executed
