...
#built-in functions
#absolute     #absolute function which is used as mode of mathematics
print('\nAbsolute')
print(abs(-34))
print(abs(45))
...
#exec (execute) is also a in-built function which is similar to eval but exec can execute multiplie lines
print('\nExec')
...
print('Converted to octacl : ',oct(a),type(oct(a)))
var='8'  #string cannont be change into integer or float if string content is not 0-9 numbers
print(int(var))
print(float(var))
f=158.3552
inti=int(f)
