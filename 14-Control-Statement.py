...
while(c<6):
    ...
    print(c)
print('Yippee!!! I am outside the loop and 4 5 6 didnt got printed')
...
while(c<10):
    c=c+1
    if(c%2==0):
        continue  #as condition is satsified continue is executed and execution control wass directly passed to starting of the loop without further execution
    print(c)

#PASS it is nothing but simply null funtion which just occupies space
print('\nPass example')
c=0
while(c<6):
    c=c+1
