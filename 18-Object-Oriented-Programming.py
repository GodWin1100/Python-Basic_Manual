...
print('\nNormal class')
class Info:
    def name(self):  #parameter cannot be empty or null in function of a class as class object is passed through function parameter
        print('Shivam')
    def age(self):
        print('18')
...
class infocard:
    def __init__(self,name,age):  #we use __init__ for taking parameter in function of a class. DOUBLE UNDERSCORE(__) both side of init
